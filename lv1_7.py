...
for i in range(5):
    ...
    count_h = int(d[0]) - int(c[0])
    
    if ( int(c[1]) == 0 and int(d[1]) == 0 ):
        count_m = 0
        
    elif ( int(c[1]) == 0 and int(d[1]) != 0 ):
        count_m = int(d[1])
        ...
        count_h -= 1
        count_m = ((60 - int(c[1])) + int(d[1]))
        
    result += ((count_h * 60) + count_m)
